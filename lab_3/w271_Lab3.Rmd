...
plot(data1$year, data1$totfatrte, type="o", col="blue", pch="o", ylab="y", lty=1)

#add second data series to the same chart using points() and lines()
points(data2$year, data2$totfatrte, col="red", pch="*")
lines(data2$year, data2$totfatrte, col="red",lty=2)
